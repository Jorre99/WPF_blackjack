...
namespace WPF_BlackJack.Presentation
{
    public class GameViewModel : ObservableObject
    {
        ...
        public List<Round> AllRounds { get; private set; }
        ...
        public void SaveData()
        {
            ...
            _gameBusiness.SaveRound(_playerData, _player.Name);
            _player.TotalBet = 0;
            _playerData.Clear();
        }
        ...
        internal void GameCommand(string commandName)
        {
            switch (commandName)
            {
                ...
                case "Objective":
                    break;
                case "About":
                    About gameHistory = new About();
                    MessageBox.Show(_player.Name);
                    AllRounds = _gameBusiness.GetRounds(_player);
                    string allRounds = string.Join(" ", AllRounds);
                    MessageBox.Show(allRounds);
